...
var _emitConnectEvent = _interopRequireDefault(
  require('./commands-utils/emitConnectEvent')
);
...
var _keyspaceNotifications = _interopRequireDefault(
  require('./keyspace-notifications')
);
  ...
  (function(_EventEmitter) {
    ...
    function RedisMock() {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(RedisMock).call(this)
      );
      ...
      _this.keyspaceEvents = (0, _keyspaceNotifications.default)(
    ...
    _createClass(RedisMock, [
      {
        ...
        value: function multi() {
          ...
          batch.forEach(function(_ref) {
            ...
            return (_this2$batch = _this2.batch)[command].apply(
              _this2$batch,
      ...
      },
      {
        ...
        value: function pipeline() {
          ...
          batch.forEach(function(_ref3) {
            ...
            return (_this3$batch = _this3.batch)[command].apply(
              _this3$batch,
              _toConsumableArray(options)
            );
          });
      ...
      },
      {
        ...
        value: function _initCommands() {
          ...
          Object.keys(commands).forEach(function(command) {
            ...
            _this4[commandName] = (0, _command.default)(
