...
var _standardAsCallback = _interopRequireDefault(
  require('standard-as-callback')
);
...
var Pipeline =
  ...
  (function() {
    ...
    _createClass(Pipeline, [
      ...
      {
        key: '_addTransaction',
        value: function _addTransaction(
          commandEmulator,
          commandName,
          commandArgs,
          callback
          ...
          this.batch.push(function() {
            return (0, _standardAsCallback.default)(
              new Promise(function(resolve) {
                return resolve(
                  _command.safelyExecuteCommand.apply(
                    void 0,
                    [commandEmulator, commandName, _this3.redis].concat(
